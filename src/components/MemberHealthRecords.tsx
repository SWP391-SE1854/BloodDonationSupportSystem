...
const MemberHealthRecords = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Eligibility Status */}
      <Card className={`border-2 ${healthRecord.eligibility_status ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}`}>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <Badge 
              className={healthRecord.eligibility_status ? 'bg-green-600' : 'bg-red-600'}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="border-red-100">
          <CardHeader>
            ...
            <CardDescription>From HealthRecords table</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <Card className="border-red-100">
        <CardHeader>
          ...
          <CardDescription>Based on your health record data</CardDescription>
        </CardHeader>
        <CardContent>
